...
def content() -> None:
    ...
    with ui.element('div').classes('row').style('font-size:1.2rem'):
        with ui.element('div').classes('col-xs-12 col-md-8'):
            ui.label(
                '''Hey, I'm William. Currently I am a resident in clinical chemistry at the Maastricht University
                    Medical Center. Moreover, I love building software. ''').style('margin-bottom: 1rem')

            ui.label('''This is my spot on the web for writing, projects, tutorials, art,
                        and anything else I want to put out there. Check out the blog, or take a
                        look at the projects page to see a highlight of my open-source work.''').style('margin-bottom: 1rem')
